  ...
  render() {
    return (
      <Col xs={12} sm={4} md={4} style={filmStyles.block} onClick={this.onChoose}>
        <img src={API.imageHost + 'w300/' + this.props.movie.poster_path} style={filmStyles.poster} />
        <Row style={filmStyles.previewInfo}>
          ...
          <Col xs={4} sm={4} md={3}
            ...
            <div style={Object.assign({}, commonStyles.text_block, filmStyles.filmYearEdge)}>{DATES.dateStringToYear(this.props.movie.release_date)}</div>
          </Col>
